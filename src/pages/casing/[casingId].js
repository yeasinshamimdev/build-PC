...
const SingleCasingPage = ({product}) => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <h1 className="text-2xl lg:text-4xl pt-8 text-center">Casing Details</h1>
      ...
      <Row  style={{ marginTop: "60px", marginBottom: "60px" }}>
        ...
        <Col md={6} lg={12} className="px-4" >
          ...
          <p className="text-[15px]"><b>fanSupport:</b> {product?.keyFeatures?.fanSupport}</p>
          <p className="text-[15px]"><b>port:</b> {product?.keyFeatures?.port}</p>
          <p className="text-[15px]"><b>model:</b> {product?.keyFeatures?.model}</p>
          <p className="text-[15px]"><b>sidePanel:</b>  {product?.keyFeatures?.sidePanel}</p>
