...
const ChoosePowerSupply = ({products}) => {
  return (
    <div>
      <Head>
        <title>Add Power Supply</title>
      </Head>
      <div className="p-4 lg:p-0">
        <h2 className="text-2xl lg:text-4xl mb-4 mt-16 font-semibold text-gray-900 text-center">Add Power Supply</h2>
