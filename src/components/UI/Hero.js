      ...
      <div className="hero min-h-screen text-black flex justify-center gap-10">
        <div className="hero-content flex-col lg:flex-row-reverse ">
          ...
          <div className="flex-1">
            ...
            <p className="py-6 text-xl lg:text-2xl">Leading Computer, Laptop & Gaming PC Retail & Online best Shop in Bangladesh. Build your dream PC with us. We are here to help you to build best performance PC.</p>
