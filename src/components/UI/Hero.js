    ...
    <div>
      <div className="hero min-h-screen text-black flex justify-center gap-10">
        <div className="hero-content flex-col lg:flex-row-reverse ">
          <div data-aos="fade-left" data-aos-duration="2000" className="rounded-lg shadow-2xl lg:w-1/2 2xl:h-1/2">
            <Image src={Banner} className='w-full ' width={400} height={400} responsive="true" alt='Hero image' />
          </div>
          <div className="flex-1" data-aos="zoom-in" data-aos-duration="1500">
